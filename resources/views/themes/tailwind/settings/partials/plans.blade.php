...
<div class="flex flex-col">
	...
	@elseif(auth()->user()->subscribed('main'))
		<h5 onclick="window.location.href='https://t.me/the_url_cutter_bot'" class="px-6 py-5 text-sm font-bold text-gray-500 bg-gray-100 border-t border-b border-gray-150">Switch Plans</h5>
	@else
