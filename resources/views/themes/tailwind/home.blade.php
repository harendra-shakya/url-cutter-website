...
@section('content')
    ...
    <section class="relative z-40 w-full pt-10 pb-16 lg:pt-5 xl:-mt-24 bg-gradient-to-b from-wave-500 via-wave-600 to-wave-400">
        ...
        <div class="relative z-20 flex flex-col items-start justify-start px-8 mx-auto sm:items-center max-w-7xl xl:px-5">
            ...
            <p class="mt-4 leading-6 sm:text-center text-wave-200">Our URL cutter bot is a powerful tool for managing and tracking links. It allows you to shorten, customize and track clicks and analytics with a user-friendly interface.<br class="hidden md:block"> Here are a few awesome features you're going to love!</p>
    ...
    <div id="pricing" class="relative">
        ...
        <div class="relative z-20 px-8 pb-8 mx-auto max-w-7xl xl:px-5">
            <div class="w-full text-left sm:text-center">
                ...
                <p class="w-full my-1 text-base text-left text-gray-900 opacity-75 sm:my-2 sm:text-center sm:text-xl">Short unlimited URLs for just $1/month</p>
            </div>
